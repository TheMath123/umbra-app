...
- Nome: **MD Reader**.
- Identificador de bundle: `com.matheuspa.mdreader`.
- Ícone: glifo "M↓" (referência ao logotipo clássico do Markdown) em gradiente indigo, aplicado a favicon e ícones de todas as plataformas do bundle.
- Licença: MIT.
